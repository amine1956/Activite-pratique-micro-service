 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://ws.example.org/", wsdlLocation = "http://localhost:8080/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://ws.example.org/", "BanqueServiceService");
     ...
     *     returns BanckSW
     */
    @WebEndpoint(name = "BanckSWPort")
    public BanckSW getBanckSWPort() {
        return super.getPort(new QName("http://ws.example.org/", "BanckSWPort"), BanckSW.class);
    }
     ...
     */
    @WebEndpoint(name = "BanckSWPort")
    public BanckSW getBanckSWPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.example.org/", "BanckSWPort"), BanckSW.class, features);
    }
